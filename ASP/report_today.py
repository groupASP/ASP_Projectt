...
#     but = Button(b, text="Export", command=export_data,width=16)
#     but.configure(font=("Times New Roman", 25), bg="#02A83F", fg="black")
#     but.place(x=900, y=750)
...
# bts = tkinter.Button(b, text="Back", command=back, width=16)
# bts.place(x=300, y=750)
# bts.configure(font=("Times New Roman", 25), bg="green", fg="white")
